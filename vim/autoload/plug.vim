...
<html lang="en">
  ...
  <meta name="request-id" content="C0A8:4E42:37D1759:52503D8:5C1CADC3" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">

    <meta name="enabled-features" content="DASHBOARD_V2_LAYOUT_OPT_IN,EXPLORE_DISCOVER_REPOSITORIES,UNIVERSE_BANNER,MARKETPLACE_PLAN_RESTRICTION_EDITOR">

  <meta name="html-safe-nonce" content="6cf905d88f76fbe6118ce02877f022a7e523c938">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-unscoped-search-url="/search" action="/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=D9mNi0dde+Ek26LBx7zMaHEl38taHngX3NFo4+gbR5vaR4WE+ivPDmr8ZKlniNUyL9Xho1JhCVX+s7d36dxFxw=="
          spellcheck="false"
          autocomplete="off"
          >
      ...
      <div class="col-md-7 text-center text-md-left ">
        ...
        <div class="mx-auto col-sm-8 col-md-5 hide-sm">
          <div class="rounded-1 text-gray bg-gray-light py-4 px-4 px-md-3 px-lg-4">
            <form class="home-hero-signup js-signup-form" autocomplete="off" action="/join" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="3XwUKNBxDl0zizdDXNvyrXV3+gaJfWb/s4K3UYrlFYs991I6bR+JrwgAS3qm+xdlT1GlnyRWmODAiF6vZBhAbw==" />              <dl class="form-group mt-0">
                <dt class="input-label">
                  <label class="form-label f5" for="user[login]">Username</label>
                </dt>
                <dd>
                  <auto-check src="/signup_check/username" csrf="qO4GOZAkyBpoBymnYXNb5wxlaOWjxFt5ZoADtDT9UGigh4EAcRcBS0PAKPbKBzPBL80QImECSmkNz12/rx62Fw==">
              ...
              <dl class="form-group">
                ...
                <dd>
                  <auto-check src="/signup_check/email" csrf="TXuBBklki3Ndnt9DeGDQlMLF1w+9v/janmwrq5jgMQB76o6Z6LQEW/ScO2uE3DdwTGfk1iVY/5K8xGlMfFSnfQ==">
              ...
              >
                <dl class="form-group">
                  ...
                  <dd>
                    ...
                    <p class="form-control-note">Make sure it&#39;s <span class="js-more-than-n-chars">more than 15 characters</span> OR <span class="js-min-chars">at least 8 characters</span> <span class="js-number-requirement">including a number</span> <span class="js-letter-requirement">and a lowercase letter</span>.<br />Read our documentation on <a href="https://help.github.com/articles/creating-a-strong-password" class="tooltipped tooltipped-s" aria-label="Learn more about strong passwords">safer password practices</a>.</p>
                  </dd>
                </dl>
              </password-strength>
              <input type="hidden" name="source" class="js-signup-source" value="form-home">
              <input type="text" name="required_field_92fb" id="required_field_92fb" hidden="hidden" class="form-control" />
<input type="hidden" name="timestamp" value="1545383364435" class="form-control" />
<input type="hidden" name="timestamp_secret" value="c04a0763d796e7310bfd1012a68d5318faab7cf16235f5f129c32695911e9a2a" class="form-control" />
...
<div class="container-lg p-responsive">
  <div class="text-center py-7 py-md-8 py-lg-9 ">
    ...
    <ul class="d-flex flex-justify-center flex-items-center flex-wrap list-style-none mt-2 mt-md-3 grayscale">
      <li><img src="https://github.githubassets.com/images/modules/site/logos/airbnb-logo.png" alt="Airbnb" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
      <li><img src="https://github.githubassets.com/images/modules/site/logos/sap-logo.png" alt="SAP" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
      <li><img src="https://github.githubassets.com/images/modules/site/logos/ibm-logo.png" alt="IBM" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
      <li><img src="https://github.githubassets.com/images/modules/site/logos/google-logo.png" alt="Google" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
      <li><img src="https://github.githubassets.com/images/modules/site/logos/paypal-logo.png" alt="PayPal" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
      <li><img src="https://github.githubassets.com/images/modules/site/logos/bloomberg-logo.png" alt="Bloomberg" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
      <li><img src="https://github.githubassets.com/images/modules/site/logos/spotify-logo.png" alt="Spotify" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
      <li><img src="https://github.githubassets.com/images/modules/site/logos/swift-logo.png" alt="Swift" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
      <li><img src="https://github.githubassets.com/images/modules/site/logos/facebook-logo.png" alt="Facebook" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
      <li><img src="https://github.githubassets.com/images/modules/site/logos/node-logo.png" alt="Node.js" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
      <li><img src="https://github.githubassets.com/images/modules/site/logos/nasa-logo.png" alt="NASA" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
      <li><img src="https://github.githubassets.com/images/modules/site/logos/walmart-logo.png" alt="Walmart" class="logo-img-sm px-2 px-sm-4 px-md-5 my-md-3"></li>
    </ul>
  </div>
</div>
...
<div class="py-7 py-md-8 py-lg-9">
  <div class="container-lg p-responsive text-center">
    ...
    <div class="apps-cluster d-flex flex-wrap flex-justify-center pb-6">
      <div class="CircleBadge CircleBadge--medium CircleBadge--feature tooltipped tooltipped-s tooltipped-no-delay" style="background-color: #553958;" aria-label="Slack"><img src="https://github.githubassets.com/images/modules/site/integrators/slackhq.png" alt="Slack" class="CircleBadge-icon"></div>
...
<div class="py-7 py-md-8 py-lg-9">
  ...
  <a href="/case-studies/ariya" class="Story-link  d-block d-lg-flex height-full rounded-1 box-shadow-extra-large">
    <div class="col-lg-6 position-relative overflow-hidden">
      <div class="casestudy-square">
        <img class="d-block height-full position-absolute" alt="Ariya Hidayat" src="https://github.githubassets.com/images/modules/site/case-studies/hero/ariya.jpg" />
      </div>
    </div>
  ...
  <a href="/case-studies/freakboy3742" class="Story-link  d-block d-lg-flex height-full rounded-1 box-shadow-extra-large">
    <div class="col-lg-6 position-relative overflow-hidden">
      <div class="casestudy-square">
        <img class="d-block height-full position-absolute" alt="Russell Keith-Magee" src="https://github.githubassets.com/images/modules/site/case-studies/hero/freakboy3742.jpg" />
      </div>
    </div>
    <div class="d-lg-flex flex-items-center col-lg-6">
      <div class="width-full text-center p-3 py-lg-0">
  ...
  <a href="/case-studies/mailchimp" class="Story-link Story-link--customer d-block d-lg-flex height-full rounded-1 box-shadow-extra-large">
    <div class="col-lg-6 position-relative overflow-hidden">
      <div class="casestudy-square">
        <img class="d-block height-full position-absolute" alt="MailChimp" src="https://github.githubassets.com/images/modules/site/case-studies/hero/mailchimp.jpg" />
      </div>
    </div>
    <div class="d-lg-flex flex-items-center col-lg-6">
      <div class="width-full text-center p-3 py-lg-0">
  ...
  <a href="/case-studies/kris-nova" class="Story-link  d-block d-lg-flex height-full rounded-1 box-shadow-extra-large">
    <div class="col-lg-6 position-relative overflow-hidden">
      <div class="casestudy-square">
        <img class="d-block height-full position-absolute" alt="Kris Nova" src="https://github.githubassets.com/images/modules/site/case-studies/hero/kris-nova.jpg" />
      </div>
    </div>
    <div class="d-lg-flex flex-items-center col-lg-6">
      <div class="width-full text-center p-3 py-lg-0">
  ...
  <a href="/case-studies/yyx990803" class="Story-link  d-block d-lg-flex height-full rounded-1 box-shadow-extra-large">
    <div class="col-lg-6 position-relative overflow-hidden">
      <div class="casestudy-square">
        <img class="d-block height-full position-absolute" alt="Evan You" src="https://github.githubassets.com/images/modules/site/case-studies/hero/yyx990803.jpg" />
      </div>
    </div>
    <div class="d-lg-flex flex-items-center col-lg-6">
      <div class="width-full text-center p-3 py-lg-0">
  ...
  <a href="/case-studies/mapbox" class="Story-link Story-link--customer d-block d-lg-flex height-full rounded-1 box-shadow-extra-large">
    <div class="col-lg-6 position-relative overflow-hidden">
      <div class="casestudy-square">
        <img class="d-block height-full position-absolute" alt="Mapbox" src="https://github.githubassets.com/images/modules/site/case-studies/hero/mapbox.jpg" />
      </div>
    </div>
    <div class="d-lg-flex flex-items-center col-lg-6">
      <div class="width-full text-center p-3 py-lg-0">
  ...
  <a href="/case-studies/jessfraz" class="Story-link  d-block d-lg-flex height-full rounded-1 box-shadow-extra-large">
    <div class="col-lg-6 position-relative overflow-hidden">
      <div class="casestudy-square">
        <img class="d-block height-full position-absolute" alt="Jess Frazelle" src="https://github.githubassets.com/images/modules/site/case-studies/hero/jessfraz.jpg" />
      </div>
    </div>
    <div class="d-lg-flex flex-items-center col-lg-6">
      <div class="width-full text-center p-3 py-lg-0">
      ...
      <div class="communitystats position-relative">
        <a href="/open-source" class="d-inline-block summarylink">
          <div class="circle d-flex flex-column flex-justify-center text-center p-4 mx-auto mt-6 mb-3 m-md-3 bg-orange box-shadow-extra-large">
            <span class="d-block h0-mktg text-normal text-white lh-condensed-ultra mb-2">100M<sup class="f2-light">*</sup></span>
  ...
  <div class="py-7 py-md-8 py-lg-9 bg-gray-dark">
    ...
    <div class="container-xl p-responsive py-6 mt-lg-6">
      <form class="home-hero-signup js-signup-form" autocomplete="off" action="/join" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="h+euYwNaU10IDX6LW4MTrZoUU9msL0RWP+3fYBXS20tnbOhxvjTUrzOGArKho/ZloDIMQAEEuklM5zae+y+Orw==" />        <div class="d-lg-flex flex-wrap flex-lg-nowrap flex-justify-between">
          <dl class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <dd>
              <auto-check src="/signup_check/username" csrf="B89qVYKlAGd7DVFVA0NQWRmaEmnqDoaQUYFcS1kAvmYPpu1sY5bJNlDKUASoNzh/OjJqrijIl4A6zgJAwuNYGQ==">
          ...
          <dl class="form-group col-12 col-sm-8 col-lg-3 mx-auto mt-0 mx-lg-0 mb-3 mb-lg-0 px-3">
            ...
            <dd>
              <auto-check src="/signup_check/email" csrf="nx73954xK9BeGQhedSwcGUuTh53aPKMckM/yywiOWFmpj/hoP+Gk+Pcb7HaJkPv9xTG0RELbpFSyZ7As7DrOJA==">
          ...
          <input type="hidden" name="source" class="js-signup-source" value="form-home">
          <input type="text" name="required_field_9ae4" id="required_field_9ae4" hidden="hidden" class="form-control" />
<input type="hidden" name="timestamp" value="1545383364443" class="form-control" />
<input type="hidden" name="timestamp_secret" value="d396526e84d0be1de2e12469471fabd0725d014ac9898845102a1b63e27f53e6" class="form-control" />
